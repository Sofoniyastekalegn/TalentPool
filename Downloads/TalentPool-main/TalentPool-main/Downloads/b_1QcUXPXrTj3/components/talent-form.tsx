...
interface TalentFormProps {
  ...
  onDataChange?: (profile: TalentProfile) => void;
}

export function TalentForm({ onSubmit, initialData, onDataChange }: TalentFormProps) {
      ...
      <Card className="w-full max-w-lg mx-auto shadow-2xl border-2 border-primary/20 bg-card/80 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <p className="text-xs text-muted-foreground/80">
            Example: John Doe and john@example.com
          </p>
        </CardHeader>
        <CardContent>
